...
async function ingestTwitter() {
  ...
  let js = readFileSync(
    "twitter-2026-06-24-e7e50c3bbd92286b4e1d2a542bbbfa969ecd08980a89cab981242f0b8ffb35d2/data/tweets.js",
    "utf-8"
  );
  ...
  for (let i = 0; i < events.length; i += CHUNK_SIZE) {
    ...
    console.log(
      `Pushing Twitter chunk ${Math.floor(i / CHUNK_SIZE) + 1} / ${Math.ceil(events.length / CHUNK_SIZE)}`
    );
    try {
