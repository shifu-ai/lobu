...
- **Events / interactivity / slash commands URL:** `https://<your-lobu-base-url>/api/v1/app-webhooks/slack`
...
3. Point event subscriptions, interactive requests, and slash commands to `https://<your-lobu-base-url>/api/v1/app-webhooks/slack`.
