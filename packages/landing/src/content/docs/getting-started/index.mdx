...
4. Suggest any provider, skill, or platform changes needed in lobu.toml.
...
The CLI exposes an admin page at `/agents` and a REST API at `/api/docs` for runtime management — adding providers, platforms, and viewing agent status.
