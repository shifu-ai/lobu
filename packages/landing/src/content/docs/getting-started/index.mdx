...
LOBU_TOKEN=$(npx @lobu/cli@latest token --raw) bunx promptfoo eval \
...
| `*/SKILL.md` (via `skillFromFile`) | [SKILL.md reference](/reference/skill-md/), [Skills](/getting-started/skills/) |
| `agents/*/evals/` | [Evaluations](/sdks/evals/) |
| `*.connector.ts` (via `connectorFromFile`) | [Connector SDK](/sdks/connectors/) |
