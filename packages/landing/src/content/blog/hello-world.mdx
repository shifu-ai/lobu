...
Pricing has evolved since launch. You can self-host the open-source stack for free, or use the managed runtime with usage-based billing. The latest managed-runtime details live on [Serverless OpenClaw](/serverless-openclaw/).
