  ...
  "personal-finance": {
    ...
    agent: {
      identity: [
        ...
        "You help them capture the financial activity they need for their HMRC Self Assessment (SA100), spanning wages, side income, savings interest, dividends, capital gains, pension contributions, charitable donations, rental income, and allowable expenses, across each tax year (6 April to 5 April).",
      ...
      soul: [
        ...
        "- `tax_year.metadata.residence_status` can change year to year (non-doms moving in/out), so record per year, not on `$member`.",
        "## Account ownership",
        ...
        "- Treaty rate (e.g. 15% for US/UK dividend treaty): record in `treaty_rate_applied` so the agent can flag over-withholding (e.g. 30% withheld instead of 15%), which is recoverable but not via the SA return.",
        "## Allowance budgeting",
