...
function webIcon(size = 12) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M19 4H5a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3zm1 13a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-6h16zm0-8H4V7a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1z" />
...
export const messagingChannels: MessagingChannel[] = [
  ...
  },
  {
    ...
    detail: "Native chat console & UI widgets",
    renderIcon: webIcon,
  },
  {
    id: "whatsapp",
