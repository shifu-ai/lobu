import {
  ...
  type RuntimeCapabilitySnapshotRequest,
  validateRuntimeCapabilitySnapshot,
} from "../../lobu/runtime-capability-snapshot-contract.js";
...
export type { RuntimeEnvironment } from "../../lobu/runtime-capability-snapshot-contract.js";
...
async function readBoundedJson(
  ...
  if (
    ...
    throw new Error("runtime capability snapshot response is too large");
  }
  if (!response.body)
    throw new Error("runtime capability snapshot response is empty");
  ...
  try {
    ...
    throw new Error("runtime capability snapshot response is not valid JSON");
  }
}
