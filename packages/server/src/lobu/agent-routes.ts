...
> = {
  ...
  notion: {
    ...
    notion_query_database_view: 'notion-query-database-view',
    'notion-get-comments': 'notion-get-comments',
    notion_get_comments: 'notion-get-comments',
    'notion-get-users': 'notion-get-users',
    notion_get_users: 'notion-get-users',
    'notion-get-teams': 'notion-get-teams',
    notion_get_teams: 'notion-get-teams',
    'notion-get-async-task': 'notion-get-async-task',
    notion_get_async_task: 'notion-get-async-task',
  },
  shifu_toolbox: {
