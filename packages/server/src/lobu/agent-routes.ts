...
> = {
  google_workspace: {
    ...
    docs_create: 'gws_docs_create',
    google_workspace_docs_create: 'gws_docs_create',
    gws_docs_create: 'gws_docs_create',
    docs_batch_update: 'gws_docs_batch_update',
    google_workspace_docs_batch_update: 'gws_docs_batch_update',
    gws_docs_batch_update: 'gws_docs_batch_update',
    sheets_read: 'gws_sheets_read',
    google_workspace_sheets_read: 'gws_sheets_read',
    gws_sheets_read: 'gws_sheets_read',
    sheets_create: 'gws_sheets_create',
    google_workspace_sheets_create: 'gws_sheets_create',
    gws_sheets_create: 'gws_sheets_create',
    sheets_values_update: 'gws_sheets_values_update',
    google_workspace_sheets_values_update: 'gws_sheets_values_update',
    gws_sheets_values_update: 'gws_sheets_values_update',
    sheets_batch_update: 'gws_sheets_batch_update',
    google_workspace_sheets_batch_update: 'gws_sheets_batch_update',
    gws_sheets_batch_update: 'gws_sheets_batch_update',
    slides_read: 'gws_slides_read',
    google_workspace_slides_read: 'gws_slides_read',
    gws_slides_read: 'gws_slides_read',
    slides_create: 'gws_slides_create',
    google_workspace_slides_create: 'gws_slides_create',
    gws_slides_create: 'gws_slides_create',
    slides_batch_update: 'gws_slides_batch_update',
    google_workspace_slides_batch_update: 'gws_slides_batch_update',
    gws_slides_batch_update: 'gws_slides_batch_update',
    ...
    chat_messages_create: 'gws_chat_messages_create',
    google_workspace_chat_messages_create: 'gws_chat_messages_create',
    gws_chat_messages_create: 'gws_chat_messages_create',
  },
  notion: {
