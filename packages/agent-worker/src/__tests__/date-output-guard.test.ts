...
describe("guardDateOutput", () => {
  ...
  test("supports affirmative Chinese scheduling predicates", () => {
    for (const [finalText, expected] of [
      ...
      ["下一場銷講舉行於 7/22（三）。", "下一場銷講舉行於 7/16（四）。"],
      ["下一場銷講举行于 7/22（三）。", "下一場銷講举行于 7/16（四）。"],
      ["下一場銷講進行於 7/22（三）。", "下一場銷講進行於 7/16（四）。"],
      ["下一場銷講进行于 7/22（三）。", "下一場銷講进行于 7/16（四）。"],
      ["下一場銷講開始於 7/22（三）。", "下一場銷講開始於 7/16（四）。"],
      ["下一場銷講开始于 7/22（三）。", "下一場銷講开始于 7/16（四）。"],
      ["下一場銷講開課於 7/22（三）。", "下一場銷講開課於 7/16（四）。"],
      ["下一場銷講开课于 7/22（三）。", "下一場銷講开课于 7/16（四）。"],
      ["下一場銷講登場於 7/22（三）。", "下一場銷講登場於 7/16（四）。"],
      ["下一場銷講登场于 7/22（三）。", "下一場銷講登场于 7/16（四）。"],
    ] as const) {
      expect(
        guardDateOutput({
